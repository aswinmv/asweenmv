...
export const translations: Record<Language, Translation> = {
  en: {
    ...
    work: {
      ...
      projects: {
        ...
        raksha: 'Raksha Ayurcare Inauguration Promo',
        rakshaDesc: 'Promotional campaign content for the Raksha Ayurcare inauguration event.',
  ...
  es: {
    ...
    work: {
      ...
      projects: {
        ...
        raksha: 'Promo de Inauguración de Raksha Ayurcare',
        rakshaDesc: 'Contenido de campaña promocional para el evento de inauguración de Raksha Ayurcare.',
  ...
  fr: {
    ...
    work: {
      ...
      projects: {
        ...
        raksha: 'Promo d\'Inauguration de Raksha Ayurcare',
        rakshaDesc: 'Contenu de campagne promotionnelle pour l\'événement d\'inauguration de Raksha Ayurcare.',
  ...
  de: {
    ...
    work: {
      ...
      projects: {
        ...
        raksha: 'Raksha Ayurcare-Eröffnungspromo',
        rakshaDesc: 'Werbekampagneninhalte für die Raksha Ayurcare-Eröffnungsveranstaltung.',
  ...
  pt: {
    ...
    work: {
      ...
      projects: {
        ...
        raksha: 'Promo de Inauguração da Raksha Ayurcare',
        rakshaDesc: 'Conteúdo de campanha promocional para o evento de inauguração da Raksha Ayurcare.',
  ...
  ja: {
    ...
    work: {
      ...
      projects: {
        title: '注目プロジェクト',
        raksha: 'Raksha Ayurcare オープニングプロモ',
        rakshaDesc: 'Raksha Ayurcareオープニングイベントのプロモーションキャンペーンコンテンツ。',
  ...
  zh: {
    ...
    work: {
      ...
      projects: {
        title: '精选项目',
        raksha: 'Raksha Ayurcare 开业推广',
        rakshaDesc: 'Raksha Ayurcare开业活动的推广活动内容。',
